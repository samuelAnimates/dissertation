...
github-repo: "samuelAnimates/dissertation"
favicon: "favicon.ico"
description: "What are the risks and benefits of using AI for health literacy? Learn about AI in public health, organizational health literacy, and why narrow, well-tested applications matter. This site shares key lessons from Samuel Mendez’s Harvard dissertation on using AI to support hea;lth communication."
output:
  bookdown::gitbook:
    config:
      toc:
