...
favicon: "favicon.ico"
description: "Learn when AI helps in health communication, and when it doesn't. Research-based findings on large language models, supervised ML, and organizational health literacy from a Harvard PhD dissertation."
output:
  bookdown::gitbook:
    config:
      toc:
